...
4. DURATION: This agreement remains in effect INDEFINITELY, even after termination of business relationship.`
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-6 w-full">
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center px-10 py-4 text-xl font-bold text-white rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform focus:outline-none focus:ring-2 focus:ring-cyan-500"
            >
              <Zap className="w-6 h-6 mr-3" />
              Start Free Analysis
            </button>
            <p className="text-slate-500 text-sm mt-4">
              No signup required • Privacy protected
            </p>
          </motion.div>
        </div>
      </section>

      {/* Form Section - Appears on Scroll */}
      <section id="upload-form" className="min-h-screen py-16 relative">
        <div className="container mx-auto px-6 w-full">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
      ...
      {/* Demo Section - Appears on Scroll */}
      <section className="py-16 relative">
        <div className="container mx-auto px-6 w-full">
          <motion.div
            ...
            className="max-w-4xl mx-auto"
          >
            <div className="bg-slate-800/20 backdrop-blur-sm border border-slate-700/30 rounded-3xl p-6">
      ...
      {/* AI Process Overview Section - Appears on Scroll */}
      <section className="py-16 relative">
        <div className="container mx-auto px-6 w-full">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
