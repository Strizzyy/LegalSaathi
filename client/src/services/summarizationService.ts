...
class SummarizationService {
  ...
  private async generateJargonFreeVersion(analysis: AnalysisResult): Promise<string> {
    try {
      // BYPASS AI SERVICE COMPLETELY - it keeps generating long responses despite our constraints
      // Use only our controlled fallback method that generates proper 5-6 line summaries
      console.log('🔄 Using controlled fallback method for consistent 5-6 line summaries (AI bypassed)');
